...
export default function initDom() {
    ...
    function addNewTab() {
        ...
        // Use the active project to determine where to add the new tab
        // Use the active project to determine where to add the new tab
            ...
            if (projectIdMatch) {
                ...
                if (!isNaN(projectId)) {
                    ...
                    if (project) {
                        ...
                        // Now reflect this change on the DOM. Remove 'active' class from old active tab,
                        // and add it to the new active tab
